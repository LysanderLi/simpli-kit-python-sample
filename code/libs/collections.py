...
class DoubleLinkList(object):
    ...
    def search(self, obj):
        """Find the node containing the data, obj type must implement __eq__

        :param obj: Linked list node data element
    ...
    def remove(self, obj):
        """Delete the node containing obj

        :param obj: Linked list node data element
        :return: None
        :raise: ValueError if node does not exist
        """
